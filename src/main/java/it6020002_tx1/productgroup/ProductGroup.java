package it6020002_tx1.productgroup;
...
//  //**********************************Lấy dữ liệu từ SQL***************************************************************
	public ArrayList<ProductGroupObject> getPgObject(ProductGroupObject similar, byte total) {
...
//  //***********************************HIỂN THỊ DANH SÁCH SẢN PHẨM***************************************************************
	public void displayPgList(ArrayList<ProductGroupObject> pgList) {
	    ...
	    if (pgList.isEmpty()) {
	        ...
	        for (ProductGroupObject pg : pgList) {
	            System.out.printf("%-5s %-20s %-10s %-15s %-10s %-15s %-20s %-20s %-20s %-10s %-20s %-10s %-10s %-5s%n",
...
//  //***********************************THÊM SẢN PHẨM***************************************************************
	public boolean addPg(ProductGroupObject item) {
...
//  //***********************************UPDATE***************************************************************
	public boolean updatePg(ProductGroupObject item) {
	    StringBuilder sql = new StringBuilder();
...
//  //************************TÌM KIẾM SẢN PHẨM THEO TÊN***************************************************************
	public ArrayList<ProductGroupObject> searchPgByName(String name) {
        ...
        try {
            ...
            while (rs.next()) {
            	ProductGroupObject pg = new ProductGroupObject();
	...
	public static void main(String[] args) {
	    ...
	    ArrayList<ProductGroupObject> items = s.getPgObject(null, (byte) 30);
	    // Hiển thị danh sách
